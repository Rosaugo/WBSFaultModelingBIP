...
\begin{comment}
\begin{figure}[htbp]
	\centerline{\includegraphics[width=50mm]{figure/example_fault_tree.eps}}
...
The description of leaf nodes are dependent on the chosen of system tree\cite{ft02}. 
